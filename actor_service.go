...
func (s *actorServicesrvc) GetAllActors(ctx context.Context, p *actorservice.GetAllActorsPayload) (res actorservice.ActorResultCollection, err error) {
	s.logger.Print("actorService.getAllActors")
	return
}

// AddActor implements addActor.
func (s *actorServicesrvc) AddActor(ctx context.Context, p *actorservice.AddActorPayload) (res *actorservice.ActorResult, err error) {
